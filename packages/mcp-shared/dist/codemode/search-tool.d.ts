 ...
 */
export declare function searchEndpoints(endpoints: ApiEndpoint[], query: string, maxResults: number): ApiEndpoint[];
/**
 * Format an endpoint for display.
 */
export declare function formatEndpoint(ep: ApiEndpoint): string;
/**
